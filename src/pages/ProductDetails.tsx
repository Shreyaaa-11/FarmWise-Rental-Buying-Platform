            ...
            <div className="space-y-4">
              ...
              <Tabs defaultValue="buy" className="w-full">
                <TabsList className="grid w-full grid-cols-2">
                  <TabsTrigger value="buy" disabled={!product.is_available_for_sale}>Buy</TabsTrigger>
                  <TabsTrigger value="rent" disabled={!product.is_available_for_rent}>Rent</TabsTrigger>
                </TabsList>
                
                <TabsContent value="buy">
                  <div className="p-4 rounded-lg border bg-card text-card-foreground">
                    <p className="mb-4">Own this equipment for your farm permanently.</p>
                ...
                <TabsContent value="rent">
                  <div className="p-4 rounded-lg border bg-card text-card-foreground">
                    <p className="mb-4">Rent this equipment for your seasonal needs.</p>
                    <div className="flex items-center justify-between">
                      <div className="text-2xl font-bold">${product.rental_price_per_day}/day</div>
                      <Button 
